...
func (d *PodCustomDefaulter) Default(ctx context.Context, obj *corev1.Pod) error {
	...
	bpfRule, spanMetrics := d.Registry.BFPGeneratesSpanMetrics(info)

	if spanMetrics {
		podlog.Info("span metrics generated by Beyla for", "namespace", obj.Namespace, "name", obj.Name, "rule", bpfRule)
	}
